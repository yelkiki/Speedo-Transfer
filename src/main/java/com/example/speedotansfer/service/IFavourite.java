...
public interface IFavourite {
    ...
    List<Favourite> getAllFavourites(String token) throws UserNotFoundException;
    // Should we create an id for each favourite item and remove by this id ?
    void removeFromFavourites(String token, Long favouriteId) throws UserNotFoundException, AuthenticationException;
}
